    ...
    <header>
        <div class="container">
            ...
            <nav class="top_nav d-flex pt-3 pb-1">
                <!-- logo -->
                <h1>
                    <a class="navbar-brand" href="admin_view_staff.jsp">FE
                    </a>
...
<input class="btn btn-outline-secondary  ml-3 my-sm-0" type="submit" value="Search">
            ...
            <!-- //bottom nav -->
            <a href="prodct.jsp">View Products</a>
            ...
            <ul class="rslides" id="slider3">
                <li class="banner">
                    <div class="container">
                        ...
                        <h4 class="w3_bbot">Review Recognizing Technology</h4>
                        <div class="slider-info mt-sm-5">
                            ...
                            <div class="bnr_clip position-relative">
                                ...
                                <p class="text-uppercase py-2"></p>
                                <%--  <a class="btn btn-primary mt-3 text-capitalize" href="shop.html" role="button"></a>--%>
                            </div>
                        </div>
                    </div>
                </li>
            ...
            <div class="container-fluid py-5 footer-copy_w3ls">
                <div class="d-lg-flex justify-content-between">
                    ...
                    <div class="cpy-right align-self-center">
                        ...
                        <p> 2019 Fashion Era. All rights reserved | Design by
                            <a href="http://w3layouts.com" class="text-secondary"> .</a>
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="modal-body pt-3 pb-5 px-sm-5">
                    <div class="row">
                        <div class="col-md-6 mx-auto align-self-center">
                            <img src="images/online12.png" class="img-fluid" alt="login_image" />
                        </div>
                        <div class="col-md-6">
                            <form name="f1" action="reg" enctype="multipart/form-data" method="post">
                                <div class="form-group">
                                    <label for="recipient-name1" class="col-form-label">First Name</label>
                                    <input type="text" class="form-control" placeholder=" " name="t1" id="recipient-name1" required="">
                                </div>
                                 <div class="form-group">
                                    <label for="recipient-name1" class="col-form-label">Last Name</label>
                                    <input type="text" class="form-control" placeholder=" " name="t2" id="recipient-name1" required="">
                                </div>
                                 <div class="form-group">
                                    <label for="recipient-name1" class="col-form-label">Photo</label>
                                    <input type="file" class="form-control" placeholder=" " name="t3" id="recipient-name1" required="">
                                </div>
                                 <div class="form-group">
                                    <label for="recipient-name1" class="col-form-label">Dob</label>
                                    <input type="date" class="form-control" placeholder=" " name="t4" id="recipient-name1" required="">
                                </div>
                                 <div class="form-group">
                                    <label for="recipient-name1" class="col-form-label">Address</label>
                                    <textarea class="form-control" placeholder=" " name="t5" id="recipient-name1" required=""></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="recipient-name1" class="col-form-label">Phone</label>
                                    <input type="text" class="form-control" placeholder=" " name="t6" id="recipient-name1" pattern="[0-9]{10}" required="">
                                </div>
                                <div class="form-group">
                                    <label for="recipient-email" class="col-form-label">Email</label>
                                    <input type="email" class="form-control" placeholder=" " name="t7" id="recipient-email" required="">
                                </div>
                                <div class="form-group">
                                    <label for="recipient-name1" class="col-form-label">Username</label>
                                    <input type="text" class="form-control" placeholder=" " name="t8" id="recipient-name1" required="">
                                </div>
                                <div class="form-group">
                                    <label for="password1" class="col-form-label">Password</label>
                                    <input type="password" class="form-control" placeholder=" " name="t9" id="password1" required="">
                                </div>
                                <%-- <div class="sub-w3l">
                                    <div class="sub-agile">
                                ...
                                <div class="right-w3l">
                                    <input type="submit" class="form-control" name="b1" value="Register">
                                    </div>
                                <%-- <table>
    <tr><td>first name</td><td><input type="text" name="t1" required=""/></td></tr>
    <tr><td>last name</td><td><input type="text" name="t2" required=""/></td></tr>
    <tr><td>photo</td><td><input type="file" name="t3" required=""/></td></tr>
    <tr><td>dob</td><td><input type="date" name="t4" required=""/></td></tr>
    
    <tr><td>address</td><td><textarea name="t5" required=""></textarea></td></tr>
     <tr>
           

     <tr><td>phone no</td><td> <INPUT type="text" name="t6" pattern="[0-9]{10}" required=""/></td></tr>
    <tr><td>email</td><td> <INPUT type="email" name="t7" required=""/></td></tr>
   
    <tr><td>username</td><td><input type="text" name="t8" required="" /></td></tr>
    <tr><td>password</td><td><input type="text" name="t9" required="" pattern=".{6,}"/></td></tr>
    <tr><td><input type="submit" name="b1"/></td></tr>
</table>--%>
                            </form>
    ...
    <div class="modal fade" id="exampleModal1" tabindex="-1" role="dialog" aria-labelledby="exampleModal1" aria-hidden="true">
        <div class="agilemodal-dialog modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body  pt-3 pb-5 px-sm-5">
                    <div class="row">
                        <div class="col-md-6 align-self-center">
                            <img src="images/on9.png" class="img-fluid" alt="login_image" />
                        </div>
                        <div class="col-md-6">
                            <%--<form action="#" method="post">
                                <div class="form-group">
                ...
                <table>
                    <tr style="height: 40px;"><td>Username</td><td><input type="text" name="t1" class="form-control input_box" placeholder="Username *"/></td></tr>
                     <tr style="height: 40px;"><td>Password</td><td><input type="password" name="t2" class="form-control input_box" placeholder="Password*"/></td></tr>
                     <tr style="height: 40px;"><td colspan="2" style="padding-left: 60px;"><input style="width: 80px;" type="Submit" name="t3" value="login"/></td></tr>
