...
public class edit extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
      ...
      c.InsertUpdate("UPDATE `reg` SET `u_add`='"+request.getParameter("n4")+"',`u_ph`='"+request.getParameter("n3")+"',`u_em`='"+request.getParameter("n2")+"' WHERE `log_id`='"+request.getParameter("n1")+"'");
//out.print("UPDATE `reg` SET `u_add`="+request.getParameter("n4")+"',`u_ph`="+request.getParameter("n3")+"',`u_em`='"+request.getParameter("n2")+"' WHERE `log_id`="+request.getParameter("n1")+"'");
 out.println("<script>alert('sucessfuly updated.');location.href='userhome.jsp';</script>");
    }
